...
void FeedbackPacket::copy(const FeedbackPacket& other)
{
    ...
    this->trySend = other.trySend;
}

void FeedbackPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cPacket::parsimPack(b);
    doParsimPacking(b,this->sendable);
    doParsimPacking(b,this->trySend);
}

void FeedbackPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->sendable);
    doParsimUnpacking(b,this->trySend);
}

bool FeedbackPacket::getSendable() const
{
    return this->sendable;
}

void FeedbackPacket::setSendable(bool sendable)
{
    this->sendable = sendable;
}

bool FeedbackPacket::getTrySend() const
{
    return this->trySend;
}

void FeedbackPacket::setTrySend(bool trySend)
{
...
unsigned int FeedbackPacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_sendable
        FD_ISEDITABLE,    // FIELD_trySend
    };
...
int FeedbackPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "sendable") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "trySend") == 0) return baseIndex + 1;
...
std::string FeedbackPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    FeedbackPacket *pp = omnetpp::fromAnyPtr<FeedbackPacket>(object); (void)pp;
    switch (field) {
        case FIELD_sendable: return bool2string(pp->getSendable());
        case FIELD_trySend: return bool2string(pp->getTrySend());
        default: return "";
    }
}
...
void FeedbackPacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    FeedbackPacket *pp = omnetpp::fromAnyPtr<FeedbackPacket>(object); (void)pp;
    switch (field) {
        case FIELD_sendable: pp->setSendable(string2bool(value)); break;
        case FIELD_trySend: pp->setTrySend(string2bool(value)); break;
...
omnetpp::cValue FeedbackPacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    FeedbackPacket *pp = omnetpp::fromAnyPtr<FeedbackPacket>(object); (void)pp;
    switch (field) {
        case FIELD_sendable: return pp->getSendable();
        case FIELD_trySend: return pp->getTrySend();
...
void FeedbackPacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    FeedbackPacket *pp = omnetpp::fromAnyPtr<FeedbackPacket>(object); (void)pp;
    switch (field) {
        case FIELD_sendable: pp->setSendable(value.boolValue()); break;
        case FIELD_trySend: pp->setTrySend(value.boolValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'FeedbackPacket'", field);
    }
}
