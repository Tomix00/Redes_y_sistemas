...
bool Packet::getClockWay() const
{
    return this->clockWay;
}

void Packet::setClockWay(bool clockWay)
{
    this->clockWay = clockWay;
}

bool Packet::getNeedFeedback() const
{
    return this->needFeedback;
}

void Packet::setNeedFeedback(bool needFeedback)
{
    this->needFeedback = needFeedback;
}

bool Packet::isFeedback() const
{
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "clockWay") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "needFeedback") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "isFeedback") == 0) return baseIndex + 5;
...
std::string PacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_clockWay: return bool2string(pp->getClockWay());
...
void PacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_clockWay: pp->setClockWay(string2bool(value)); break;
...
void PacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_clockWay: pp->setClockWay(value.boolValue()); break;
